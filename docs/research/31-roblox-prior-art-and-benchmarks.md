...
> (GitHub source code read directly, web-search summaries of DevForum threads, Roblox's own
...
>
> **Sources blocked from this environment and therefore absent:** `create.roblox.com`,
> `devforum.roblox.com`, `luau.org`, `wally.run`, and the authenticated GitHub REST API. Where a Roblox doc claim appears below it came from the
