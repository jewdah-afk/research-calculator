...
function run(argv) {
  ...
  const man = {
    about: 'Generated by `node roblox/tile.js` (REALM.md section 3). Tiles are PNG, <= 1024 px, content rect + 2 px gutter. ' +
      'Client: ImageRectOffset = rectOffset, ImageRectSize = rectSize, placed at `local` (layer-local px) in a layer container of `size`; ' +
      'every tile except the last column / row is drawn 1 map point wider / taller. Empty tiles (file null) are not uploaded.',
